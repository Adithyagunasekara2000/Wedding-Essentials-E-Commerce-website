...
const Favor = () => {
  ...
  const favorItem = {
    ...
    price: 180,
    image: '/images/favors.jpeg',
  };

  const addToCart = () => {
    setCart([...cart, favorItem]);
  };
  ...
  return (
    <div style={styles.page}>
      ...
      <div style={styles.container}>
        <img src={favorItem.image} alt={favorItem.name} style={styles.image} />
        <div style={styles.details}>
          <h2 style={styles.title}>{favorItem.name}</h2>
          <p style={styles.description}>{favorItem.description}</p>
          <p style={styles.price}>${favorItem.price}</p>
