...
const Invitation = () => {
  ...
  const invitationItem = {
    ...
    price: 180,
    image: '/images/invitaton.jpeg',
  };

  const addToCart = () => {
    setCart([...cart, invitationItem]);
  };
  ...
  return (
    <div style={styles.page}>
      ...
      <div style={styles.container}>
        <img src={invitationItem.image} alt={invitationItem.name} style={styles.image} />
        <div style={styles.details}>
          <h2 style={styles.title}>{invitationItem.name}</h2>
          <p style={styles.description}>{invitationItem.description}</p>
          <p style={styles.price}>${invitationItem.price}</p>
